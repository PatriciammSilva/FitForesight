...
X1 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
y1 = df['ACR.RADL_LNTH']
...
## Variable 11 : FOREARM.HAND_LENTH  
   # Selecionar variáveis 
X11 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 13 : INTRSCY_MID_DIST   
   # Selecionar variáveis 
X13 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 15 : RADIALE.STYLION_LNTH   
   # Selecionar variáveis 
X15 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 18 : SHOULDER_ELBOW_LNTH  
   # Selecionar variáveis 
X18 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 20 : SLEEVE.OUTSEAM_LNTH  
   # Selecionar variáveis 
X20 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 21 : WAIST_NAT_LNTH  
   # Selecionar variáveis 
X21 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 22 : WAIST_OMPH_LNTH  
   # Selecionar variáveis 
X22 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 24 : WST_OMP_FRONT  
   # Selecionar variáveis 
X24 = df[['CHEST_CIRC_AT_SCYE', 'ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
d23 = pd.DataFrame({'v19': v19, 'v21': v21, 'v24': v24, 'v25': v25})  
   # Selecionar variáveis 
X23 = d23[['v19', 'v21', 'v24', 'v25']]
...
df1dupla = pd.DataFrame(data)
print(df1dupla)
df1dupla.to_csv('df1dupla.csv', index=False)