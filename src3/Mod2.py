...
## Variable 19 : SPINE_TO_ELBOW_LNTH_.SL.  
   # Selecionar variáveis 
X19 = df[['ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Variable 21 : WAIST_NAT_LNTH  
   # Selecionar variáveis 
X21 = df[['SCYE_CIRC_OVER_ACROMION']]
...
## Variable 22 : WAIST_OMPH_LNTH  
   # Selecionar variáveis 
X22 = df[['ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION', 'WST_OMP_FRONT']]
...
## Variable 23 : WST_OMP_FRONT  
   # Selecionar variáveis 
X23 = df[['WST_OMP_FRONT']]
...
## Variable 25 : WRIST_CIRC.STYLION  
   # Selecionar variáveis 
X25 = df[['ELBOW_CIRC.EXTENDED', 'SCYE_CIRC_OVER_ACROMION']]
...
## Criar dataset
data = {'V1': v1, 'V2': v2, 'V3': v3, 'V4': v4, 'V5': v5, 'V6': v6, 'V7': v7, 'V8': v8, 'V9': df['ELBOW_CIRC.EXTENDED'], 'V10': v10, 'V11': v11, 'V12': v12,'V13': v13,'V14': v14,'V15': v15,'V16': df['SCYE_CIRC_OVER_ACROMION'],'V17': v17,'V18': v18,'V19': v19,'V20': v20,'V21': v21,'V22': v22,'V23': v23,'V24': df['WST_OMP_FRONT'],'V25': v25}
